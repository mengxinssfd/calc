...
test('Calc 2', () => {
    ...
    expect(Calc.init(100)["+"](c.reset()).by(10, "-").curVal).toBe(-100);
    expect(Calc.init(100)["-"](c).curVal).toBe(94);
    expect(Calc.init(100)["*"](c.reset()).by(10, "-").curVal).toBe(-990);
    expect(Calc.init(100)["/"](c.reset()).by(10, "-").curVal).toBe(0);
});
